...
import org.jhoffmann.photostorybook.databinding.FragmentStorySlideShowBinding
...
class StorySlideShow : Fragment() {
    ...
    override fun onCreateView(
        ...
        binding = DataBindingUtil.inflate(inflater, R.layout.fragment_story_slide_show, container, false )
        viewModel = ViewModelProvider(requireActivity()).get(PhotoStoryViewModel::class.java)

        pagerAdapter = ImagePagerAdapter(viewModel.currentPhotoStory.value!!.photos, false)
        binding.slideShowViewPager.adapter = pagerAdapter
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        /*fullscreenContent = view.findViewById(R.id.slideShowViewPager)
        fullscreenContentControls = view.findViewById(R.id.fullscreen_content_controls)*/
        // Set up the user interaction to manually show or hide the system UI.
        binding.slideShowViewPager.setOnClickListener { toggle() }
